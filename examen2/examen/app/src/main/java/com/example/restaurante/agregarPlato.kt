...
import kotlinx.android.synthetic.main.activity_agregar__plato.*
import java.lang.Exception


class agregarPlato : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_agregar__plato)
    ...
    fun guardarPlato() {
        ...
        var padre = this;
        try{
            var platoCreated: PlatoHttp? = platoService.create(newPlato);
            if (platoCreated != null) {
                Toast.makeText(this, "Plato creado correctamente!", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(this, "Plato no creado!", Toast.LENGTH_SHORT). show();
            }
        }catch (e: Exception){
