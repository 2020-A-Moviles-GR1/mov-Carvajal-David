...
class PlatoAdapter(private val mcontext: Context, protected val listaPlatos: List<PlatoHttp>): ArrayAdapter<PlatoHttp>(mcontext, 0, listaPlatos) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        var layout = LayoutInflater.from(mcontext).inflate(R.layout.item_plato, parent, false);
