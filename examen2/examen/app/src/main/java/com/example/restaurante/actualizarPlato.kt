...
class actualizarPlato : AppCompatActivity() {
    ...
    private val connection = object : ServiceConnection {
        override fun onServiceConnected(className: ComponentName, service: IBinder) {
            ...
            platoObtenido = platoService.getId(idActualizar);
            if (platoObtenido != null) {
                ...
                Toast.makeText(padre, "Plato no cargado!", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    fun onClickButtonActualizar() {
        ...
        var platoActualizado: PlatoHttp? = platoService.update(idActualizar, newPlato);
        if (platoActualizado != null && platoObtenido != null) {
            ...
            Toast.makeText(this, "Plato actualizado correctamente", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Plato no actualizado", Toast.LENGTH_SHORT).show();
        }
    }
